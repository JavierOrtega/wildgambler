 ...
 */
DomBuilderIphone.build = function (objHead, objBody)
{
    /////////////////////////////////////////////////Head/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    var objMetaApple = document.createElement ('meta');
    objMetaApple.name = "apple-mobile-web-app-capable";
    objMetaApple.content = "yes";    
    objHead.appendChild(objMetaApple);
