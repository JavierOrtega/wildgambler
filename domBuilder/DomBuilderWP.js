 ...
 */
DomBuilderWP.build = function (objHead, objBody)
{
    /////////////////////////////////////////////////Head/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    var objMetaViewPort = document.createElement ('meta');
    objMetaViewPort.name = "viewport";
    
    objMetaViewPort.content = "width=device-width, initial-scale=1, maximum-scale=1, minimum-scale=1, user-scalable=no";
    ...
    objBody.appendChild(objWrapper);
        ...
        objIframe.setAttribute("scrolling", "no"); //TODO: objIframe.scrolling = "no";
